      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3><?php echo $perbarang['ID_KATEGORI'];?></h3>
              <a href="index.php?halaman=kategoriselengkapnya&id=<?php echo $perbarang['ID_KATEGORI'];?> " class="btn-danger btn">Selengkapnya</a>
